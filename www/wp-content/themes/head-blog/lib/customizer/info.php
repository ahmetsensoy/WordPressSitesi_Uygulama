 ...
 */
class head_blog_Customize_Section_Pro extends WP_Customize_Section {
...
add_action( 'customize_register', 'head_blog_page_sections_pro' );
function head_blog_page_sections_pro( $manager ) {
	// Register custom section types.
	$manager->register_section_type( 'head_blog_Customize_Section_Pro' );

	// Register sections.
	$manager->add_section(
		new head_blog_Customize_Section_Pro(
			$manager,
			'head_blog_page_view_pro',
			array(
				'title'    => esc_html__( 'Upgrade to', 'head-blog' ),
				'priority' => 5, 
